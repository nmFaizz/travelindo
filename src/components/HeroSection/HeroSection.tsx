...
export default function HeroSection() {
    ...
    return (
        <div className={`flex flex-col md:flex-row items-center lg:pl-32 sm:pl-12 py-12 gap-12 md:h-[80vh] h-auto`}>
            <div className="max-w-[550px] flex items-center flex-col md:block px-4 md:px-0">
                <div className="">
                ...
                <div className="border-[1px] border-gray-300 flex mt-16 p-1">
                ...
                <div className="mt-16 max-w-[420px]">
                    <p className="font-[500] text-center md:text-start">Much beautiful and refreshing places as you need to satisfy your best trip and make an amazing experience. Go explore our packages</p>
                </div>
            ...
            <div className="w-full h-full flex gap-5 overflow-x-scroll no-scrollbar pl-4 md:pl-0">
